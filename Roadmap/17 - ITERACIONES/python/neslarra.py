...
def numerar_iterador(inicio=0, fin=100):
    salida = ""
    numeros = Numerar(inicio, fin)
...
print(f"Caso {caso.__next__()}: mostrar números del 1 al 10 con un iterador:   {numerar_iterador(1, 10)}")
...
print(f"""Caso {caso.__next__()}: mostrar números del 1 al 10 con enumerate:     {numerar_enumerate(['cero', 'uno', 'dos', 'tres', 'cuatro',
                                                                                                 ...
                                                                                                 'once', 'doce'], 1, 10)}""")
print(f"Caso {caso.__next__()}: mostrar números del 1 al 10 con un iterador:   la numeración de los casos con la variable 'caso'")
