public class DavidQuinones {
    public static void main(String[] args) {
        ...
        // Ejemplo de función sin parámetro y con retorno
        ...
        // Funciones del sistema (uso de métodos de la clase Math y String)
        System.out.println("El valor de PI es: " + Math.PI);
        System.out.println("El valor de la raíz cuadrada de 25 es: " + Math.sqrt(25));
        ...
        System.out.println("El valor de la cadena 'Hola' en mayúsculas es: " + "Hola".toUpperCase());
