...
int main() {
	 ...
	 * Crea una funci├│n que reciba dos par├ímetros de tipo cadena de texto y retorne un n├║mero.
	 * - La funci├│n imprime todos los n├║meros del 1 al 100. Teniendo en cuenta que:
	 *   - Si el n├║mero es m├║ltiplo de 3, muestra la cadena de texto del primer par├ímetro.
	 *   - Si el n├║mero es m├║ltiplo de 5, muestra la cadena de texto del segundo par├ímetro.
