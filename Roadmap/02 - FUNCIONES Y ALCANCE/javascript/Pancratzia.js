...
function javaScriptOriginalFunction(){
    ...
    console.log('Existen funciones nativas de JavaScript. Por ejemplo, el método Math.max() que retorna el número mayor entre dos números o el console.log que muestra por consola el argumento que le pasemos');
}

const arrowFunction = () =>{
    console.log("Existen las funciones flecha, que se definen de la siguiente manera: let arrowFunction = () => { }");
}
...
globalAndLocal();
console.log(`En la función globalAndLocal() la variable global fue modificada a: ${globalVariable}. Además, la variable local solo existe dentro de la función.`);