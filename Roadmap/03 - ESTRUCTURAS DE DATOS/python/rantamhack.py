...
'''
list_strings = ["Luis", "María", "Helena", "Pedro", "Ignacio", "Jose", "Zoe", "Candela"]
print(list_strings)
...
# Actualización
list_strings[-1] = "Angel" # Actualiza la lista cambiando la posición indicada por el nuevo elemento
print(list_strings)
...
'''
tuple_strings = ("Luis", "María", "Helena", "Pedro", "Ignacio", "Jose", "Zoe", "Candela")
print(tuple_strings)
...
set_strings = set(["Luis", "María", "Helena", "Pedro", "Ignacio", "Jose", "Zoe", "Candela"])
print(set_strings)
