...
def extra() -> None:
    ...
    while True:
        ...
        if pokeapi.status_code == 200:
            ...
            with open('./Pokemon_info.json', mode="w", encoding="utf-8") as write_file:
                json.dump(search_pokemon_info, write_file, indent=4)
            ...
            with open('./Pokemon_info_2.json', mode="w", encoding="utf-8") as write_file2:
                json.dump(search_pokemon_info2, write_file2, indent=4)
            ...
            with open('./Pokemon_info_3.json', mode="w", encoding="utf-8") as write_file3:
                json.dump(search_pokemon_evol, write_file3, indent=4)
